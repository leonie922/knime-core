 ...
 */
class ProbabilityDistributionMajorityClassRenderer extends DefaultDataValueRenderer {
    /**
    *
    */
   ...
   protected void setValue(final Object value) {
       if (value instanceof ProbabilityDistributionValue) {
           ...
           for (int i = 0; i < probDistrValue.size(); i++) {
              if(probDistrValue.getProbability(i) > maxValue) {
                maxValue = probDistrValue.getProbability(i);
                index = i;
            }
           }
           super.setValue(classNames.get(index));
       } else {
