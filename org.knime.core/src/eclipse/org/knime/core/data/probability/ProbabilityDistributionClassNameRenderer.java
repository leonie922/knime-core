 ...
 */
class ProbabilityDistributionClassNameRenderer extends DefaultDataValueRenderer {
    /**
     *
     */
    ...
    protected void setValue(final Object value) {
        if (value instanceof ProbabilityDistributionValue) {
            ...
            List<String> classNames = m_spec.getElementNames();
            String[] classAndValues = new String[probDistrValue.size()];
            for (int i = 0; i < probDistrValue.size(); i++) {
                classAndValues[i] = classNames.get(i) + ": " + format.format(probDistrValue.getProbability(i));
            }
            super.setValue(Arrays.toString(classAndValues));
        } else {
